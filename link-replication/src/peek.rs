...
fn ref_prefixes(id: &PeerId, remote_id: &PeerId) -> impl Iterator<Item = RefPrefix> {
    vec![
        refs::scoped(id, remote_id, refs::REFS_RAD_ID).into(),
        refs::scoped(id, remote_id, refs::REFS_RAD_SELF).into(),
        refs::scoped(id, remote_id, refs::REFS_RAD_SIGNED_REFS).into(),
        {
...
fn required_refs<'a>(
    ...
    vec![
        refs::scoped(id, remote_id, refs::REFS_RAD_ID),
        refs::scoped(id, remote_id, refs::REFS_RAD_SIGNED_REFS),
    ]
    .into_iter()
}
