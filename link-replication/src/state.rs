    ...
    Urn: Ord,
{
    ...
    pub fn insert_id_tip(&mut self, of: PeerId, tip: ObjectId) {
    ...
    pub fn insert_sigref_tip(&mut self, of: PeerId, tip: ObjectId) {
        self.sigs.insert(of, tip);
    }

    pub fn insert_delegation_tip(&mut self, remote_id: PeerId, urn: Urn, tip: ObjectId) {
        self.dels
            .entry(remote_id)
